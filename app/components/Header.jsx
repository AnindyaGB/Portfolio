  ...
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      <div>
        ...
        <p>
            Ambitious Engineer from Scotland, living in Toronto, with 5 years of software experience. In my work I enjoy a 
            challenge that requires tough problem solving and I am happy to work solo or as part of a team.         </p>
